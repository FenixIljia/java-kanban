...
public class SubTaskHandlerTest {
    ...
    public void addSubTask() throws IOException, InterruptedException {
        Epic epic = new Epic("Epic", "Description", Variety.EPIC);
    ...
    @Test
    public void getCode406AtIntersectionSubTaskAtAddSubTask() throws IOException, InterruptedException {
        Epic epic = new Epic("Epic", "Description", Variety.EPIC);
    ...
    @Test
    public void getCode200AtDeleteSubTask() throws IOException, InterruptedException {
        Task task = new Task(
                "Test",
                "Description",
                Status.NEW,
