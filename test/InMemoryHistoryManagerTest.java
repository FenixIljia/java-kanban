...
class InMemoryHistoryManagerTest {
    ...
    public void getNotNullAtEqualsSubTask1WithGenerationIdentifierWithSubTask2WithAddIdentifier() {
        Epic epic = new Epic("", "", Status.NEW, Variety.EPIC);
    ...
    public void getNotNullWhenTaskNotChangesAtAddTaskManager() {
        Task task = new Task("", "", Status.NEW, Variety.TASK);
    ...
    public void getNotNullWhenEpicNotChangesAtAddEpicManager() {
        Epic task = new Epic("", "", Status.NEW, Variety.EPIC);
    ...
    public void getNotNullWhenSubTaskNotChangesAtAddSubTaskManager() {
        ...
        SubTask task = new SubTask("", "", epic.getIdentifier(), Status.NEW, Variety.SUBTASK);
    ...
    public void getNotNullAtGetHistoryTask() {
        Task task1 = new Task("", "", Status.NEW, Variety.TASK);
        Task task2 = new Task("Test2", "", Status.NEW, Variety.TASK);
        Task task3 = new Task("Test3", "", Status.NEW, Variety.TASK);
    ...
    public void getNotNullAtGetHistoryEpic() {
        Epic task1 = new Epic("", "", Status.NEW, Variety.EPIC);
        Epic task2 = new Epic("", "", Status.NEW, Variety.EPIC);
        Epic task3 = new Epic("", "", Status.NEW, Variety.EPIC);
    ...
    public void getNotNullAtGetHistorySubTask() {
        ...
        SubTask task1 = new SubTask("", "", idEpic, Status.NEW, Variety.SUBTASK);
        SubTask task2 = new SubTask("", "", idEpic, Status.NEW, Variety.SUBTASK);
        SubTask task3 = new SubTask("", "", idEpic, Status.NEW, Variety.SUBTASK);
    ...
    public void getNotNullEqualsAfterUpDataSubTask() {
        Epic epic = new Epic("", "", Status.DONE, Variety.EPIC);
        taskManager.addEpic(epic);
        SubTask task1 = new SubTask("", "", epic.getIdentifier(), Status.NEW, Variety.SUBTASK);
    ...
    public void getNullAtRemoveSubTask() {
        ...
        SubTask subTask1 = new SubTask("", "", epic.getIdentifier(), Status.NEW, Variety.SUBTASK);
