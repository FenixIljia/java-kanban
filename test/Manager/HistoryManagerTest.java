...
class HistoryManagerTest {
    ...
    @Test
    public void getNotNullAtGetHistoryTask() throws ManagerIntersectionException {
        Task task1 = new Task(
                "",
                "",
                Status.NEW,
    ...
    @Test
    public void getNotNullAtGetHistorySubTask() throws ManagerIntersectionException {
    ...
    @Test
    public void getCorrectAtRemoveFromHistory() throws ManagerIntersectionException {
        Task task1 = new Task(
                "Test1",
                "Test1",
                Status.NEW,
