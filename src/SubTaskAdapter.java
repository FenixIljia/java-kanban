...
public class SubTaskAdapter extends TypeAdapter<SubTask> {
    ...
    public void write(JsonWriter out, SubTask subTask) throws IOException {
        ...
        // Поля из родительского класса Task
        ...
        out.name("status").value(subTask.getStatus().toString()); // Используется StatusAdapter
        out.name("variety").value(subTask.getVariety().toString()); // Используется VarietyAdapter
        ...
        while (in.hasNext()) {
            ...
            switch (field) {
                ...
                case "identifier":
                    ...
                    break;
                case "status":
                    status = new StatusAdapter().read(in); // Используется StatusAdapter
                    break;
                case "variety":
                    variety = new VarietyAdapter().read(in); // Используется VarietyAdapter
                    break;
                case "duration":
